...
class WallpaperRepository(private val cache: WallpaperDataSource, private val network: NetworkNetworkSource, private val mapper: WallpaperMapper) {


    val restoredList: Observable<List<WallpaperDb>>
    ...
    fun getListByPage(page: Int): Observable<List<WallpaperDb>> {
    ...
    private fun mapWallpaper(list: WallpaperList?, page: Int): List<WallpaperDb> {
